      ...
      <div class="nav-actions">
        <div class="dropdown">
          ...
          <div class="dropdown-menu" id="accountMenu" aria-label="Account options">
            ...
            <a href="/my_watchlist.html"><span>My Watchlist</span></a>
...
<div class="search-container">
  <div class="search-box">
    ...
    <input type="text" placeholder="Search for top-rated products..." class="search-input">
  ...
  <div class="filter-row">
    <div class="filter-options">
      ...
      <a href="../html/review_dashboard.html">
      <button class="dash-btn">Review Visualisation Dashboard</button>
      </a>
    </div>
